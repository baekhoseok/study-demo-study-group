...
class MainControllerTest {
    ...
    private void beforeEach() {
        ...
        signUpForm.setEmail("hoseok@naver.com");
        signUpForm.setNickname("hoseok");
    ...
    @DisplayName("이메일 로그인 성")
    @Test
    public void login_with_email() throws Exception {

        mockMvc.perform(post("/login")
                        .param("username", "hoseok@naver.com")
